...
names of artists who were born in and died in 20th century (1900-2000) example born in 1901 and died in 
1959 - included / born in 1889 and died in 1925 not included - should return ["Salvador Dali", "Frida Kahlo"]*/

function get20s(array){
  names = [];
  for(i = 0; i < array.length; i++){
    let yearArray = Array.from(array[i].years);
    if(yearArray[0] === "1" && yearArray[1] === "9"){
